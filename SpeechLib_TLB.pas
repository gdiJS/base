...
// $Rev: 52393 $
// File generated on 10.09.2013 15:37:03 from Type Library described below.
...
//   Error creating palette bitmap of (TSpNotifyTranslator) : Server C:\Program Files\Common Files\Microsoft Shared\Speech\sapi.dll contains no icons
...
//   Error creating palette bitmap of (TSpResourceManager) : Server C:\Program Files\Common Files\Microsoft Shared\Speech\sapi.dll contains no icons
//   Error creating palette bitmap of (TSpStreamFormatConverter) : Server C:\Program Files\Common Files\Microsoft Shared\Speech\sapi.dll contains no icons
//   Error creating palette bitmap of (TSpMMAudioEnum) : Server C:\Program Files\Common Files\Microsoft Shared\Speech\sapi.dll contains no icons
...
//   Error creating palette bitmap of (TSpRecPlayAudio) : Server C:\Program Files\Common Files\Microsoft Shared\Speech\sapi.dll contains no icons
//   Error creating palette bitmap of (TSpStream) : Server C:\Program Files\Common Files\Microsoft Shared\Speech\sapi.dll contains no icons
...
//   Error creating palette bitmap of (TSpCompressedLexicon) : Server C:\Program Files\Common Files\Microsoft Shared\Speech\sapi.dll contains no icons
...
//   Error creating palette bitmap of (TSpNullPhoneConverter) : Server C:\Program Files\Common Files\Microsoft Shared\Speech\sapi.dll contains no icons
...
// *********************************************************************//
  ISpObjectToken = interface(ISpDataKey)
    ...
    function IsUISupported(var pszTypeOfUI: Word; pvExtraData: Pointer; cbExtraData: LongWord; 
    ...
    function DisplayUI(var hWndParent: _RemotableHandle; var pszTitle: Word; var pszTypeOfUI: Word; 
                       pvExtraData: Pointer; cbExtraData: LongWord; const punkObject: IUnknown): HResult; stdcall;
...
// *********************************************************************//
  ISpVoice = interface(ISpEventSource)
    ...
    function DisplayUI(var hWndParent: _RemotableHandle; var pszTitle: Word; var pszTypeOfUI: Word; 
                       pvExtraData: Pointer; cbExtraData: LongWord): HResult; stdcall;
  end;
...
// *********************************************************************//
  ISpGrammarBuilder = interface(IUnknown)
    ...
    function AddWordTransition(hFromState: Pointer; hToState: Pointer; var psz: Word; 
    ...
    function AddRuleTransition(hFromState: Pointer; hToState: Pointer; hRule: Pointer; 
                               Weight: Single; var pPropInfo: SPPROPERTYINFO): HResult; stdcall;
    function AddResource(hRuleState: Pointer; var pszResourceName: Word; var pszResourceValue: Word): HResult; stdcall;
...
// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TSpRecPlayAudio
// Help String      : SpRecPlayAudio Class
// Default Interface: ISpObjectWithToken
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (530) CanCreate Hidden Restricted
// *********************************************************************//
  TSpRecPlayAudio = class(TOleServer)
  private
    FIntf: ISpObjectWithToken;
    function GetDefaultInterface: ISpObjectWithToken;
  protected
    procedure InitServerData; override;
  public
    constructor Create(AOwner: TComponent); override;
...
// *********************************************************************//
  ...
  public
    ...
    function AddPronunciation(var pszWord: Word; LangId: Word; ePartOfSpeech: SPPARTOFSPEECH; 
                              var pszPronunciation: Word): HResult;
    function RemovePronunciation(var pszWord: Word; LangId: Word; ePartOfSpeech: SPPARTOFSPEECH; 
                                 var pszPronunciation: Word): HResult;
...
// *********************************************************************//
  ...
  public
    ...
    function SetObjectToken(const pToken: ISpObjectToken): HResult;
    function GetObjectToken(var ppToken: ISpObjectToken): HResult;
    function PhoneToId(var pszPhone: Word; out pId: Word): HResult;
    function IdToPhone(var pId: Word; out pszPhone: Word): HResult;
...
procedure TSpRecPlayAudio.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{FEE225FC-7AFD-45E9-95D0-5A318079D911}';
    IntfIID:   '{5B559F40-E952-11D2-BB91-00C04F8EE6C0}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TSpRecPlayAudio.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as ISpObjectWithToken;
  end;
end;

procedure TSpRecPlayAudio.ConnectTo(svrIntf: ISpObjectWithToken);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TSpRecPlayAudio.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TSpRecPlayAudio.GetDefaultInterface: ISpObjectWithToken;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TSpRecPlayAudio.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
end;

destructor TSpRecPlayAudio.Destroy;
begin
  inherited Destroy;
end;

function TSpRecPlayAudio.SetObjectToken(const pToken: ISpObjectToken): HResult;
begin
  Result := DefaultInterface.SetObjectToken(pToken);
end;

function TSpRecPlayAudio.GetObjectToken(var ppToken: ISpObjectToken): HResult;
begin
...
function TSpStream.BindToFile(var pszFileName: Word; eMode: SPFILEMODE; var pFormatId: TGUID; 
                              var pWaveFormatEx: WaveFormatEx; ullEventInterest: Largeuint): HResult;
begin
...
function TSpCompressedLexicon.GetPronunciations(var pszWord: Word; LangId: Word; dwFlags: LongWord; 
                                                var pWordPronunciationList: SPWORDPRONUNCIATIONLIST): HResult;
begin
  Result := DefaultInterface.GetPronunciations(pszWord, LangId, dwFlags, pWordPronunciationList);
end;

function TSpCompressedLexicon.AddPronunciation(var pszWord: Word; LangId: Word; 
                                               ePartOfSpeech: SPPARTOFSPEECH; 
                                               var pszPronunciation: Word): HResult;
begin
...
function TSpCompressedLexicon.RemovePronunciation(var pszWord: Word; LangId: Word; 
                                                  ePartOfSpeech: SPPARTOFSPEECH; 
                                                  var pszPronunciation: Word): HResult;
begin
...
function TSpNullPhoneConverter.PhoneToId(var pszPhone: Word; out pId: Word): HResult;
begin
  Result := DefaultInterface.PhoneToId(pszPhone, pId);
end;

function TSpNullPhoneConverter.IdToPhone(var pId: Word; out pszPhone: Word): HResult;
begin
...
begin
  RegisterComponents(dtlServerPage, [TSpNotifyTranslator, TSpObjectTokenCategory, TSpObjectToken, TSpResourceManager, 
    TSpStreamFormatConverter, TSpMMAudioEnum, TSpMMAudioIn, TSpMMAudioOut, TSpRecPlayAudio, 
    TSpStream, TSpVoice, TSpSharedRecoContext, TSpInprocRecognizer, TSpSharedRecognizer, 
    TSpLexicon, TSpUnCompressedLexicon, TSpCompressedLexicon, TSpPhoneConverter, TSpNullPhoneConverter, 
    TSpTextSelectionInformation, TSpPhraseInfoBuilder, TSpAudioFormat, TSpWaveFormatEx, TSpInProcRecoContext, 
    TSpCustomStream, TSpFileStream, TSpMemoryStream]);
end;
