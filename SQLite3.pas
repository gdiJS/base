...
function sqlite3_bind_text16(hStmt: TSqliteStmt; ParamNum: integer; Text: PChar; numBytes: integer; ptrDestructor: TSQLite3Destructor): integer; cdecl; external SQLiteDLL name 'sqlite3_bind_text16';
...
function SQLite3_create_collation16(db: TSQLiteDB; Name: PChar; eTextRep: integer; UserData: pointer; xCompare: TCollateXCompare): integer; cdecl; external SQLiteDLL name 'sqlite3_create_collation';
