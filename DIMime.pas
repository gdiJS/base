...
function MimeEncodeString(const s: RawByteString): RawByteString;

function MimeEncodeStringNoCRLF(const s: RawByteString): RawByteString;

function MimeDecodeString(const s: RawByteString): RawByteString;

function MimeEncodedSize(const InputSize: NativeUInt): NativeUInt;

function MimeEncodedSizeNoCRLF(const InputSize: NativeUInt): NativeUInt;

function MimeDecodedSize(const InputSize: NativeUInt): NativeUInt;

procedure DecodeHttpBasicAuthentication(const BasicCredentials: RawByteString; out UserId: RawByteString; out Password: RawByteString);

procedure MimeEncode(const InputBuffer; const InputByteCount: NativeUInt; out OutputBuffer);

procedure MimeEncodeNoCRLF(const InputBuffer; const InputByteCount: NativeUInt; out OutputBuffer);

procedure MimeEncodeFullLines(const InputBuffer; const InputByteCount: NativeUInt; out OutputBuffer);

function MimeDecode(const InputBuffer; const InputBytesCount: NativeUInt; out OutputBuffer): NativeUInt;

function MimeDecodePartial(const InputBuffer; const InputBytesCount: NativeUInt; out OutputBuffer; var ByteBuffer: NativeUInt; var ByteBufferSpace: NativeUInt): NativeUInt;

function MimeDecodePartialEnd(out OutputBuffer; const ByteBuffer: NativeUInt; const ByteBufferSpace: NativeUInt): NativeUInt;
...
const
  MIME_ENCODE_TABLE: array[0..63] of AnsiChar = (#065, #066, #067, #068, #069, #070, #071, #072, #073, #074, #075, #076, #077, #078, #079, #080, #081, #082, #083, #084, #085, #086, #087, #088, #089, #090, #097, #098, #099, #100, #101, #102, #103, #104, #105, #106, #107, #108, #109, #110, #111, #112, #113, #114, #115, #116, #117, #118, #119, #120, #121, #122, #048, #049, #050, #051, #052, #053, #054, #055, #056, #057, #043, #047);
  MIME_PAD_CHAR = '=';
  MIME_DECODE_TABLE: array[AnsiChar] of Byte = (255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 062, 255, 255, 255, 063, 052, 053, 054, 055, 056, 057, 058, 059, 060, 061, 255, 255, 255, 255, 255, 255, 255, 000, 001, 002, 003, 004, 005, 006, 007, 008, 009, 010, 011, 012, 013, 014, 015, 016, 017, 018, 019, 020, 021, 022, 023, 024, 025, 255, 255,
    255, 255, 255, 255, 026, 027, 028, 029, 030, 031, 032, 033, 034, 035, 036, 037, 038, 039, 040, 041, 042, 043, 044, 045, 046, 047, 048, 049, 050, 051, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
