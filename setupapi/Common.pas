...
type
  ...
  _DEVICE_POWER_STATE = ( PowerDeviceUnspecified, PowerDeviceD0, PowerDeviceD1,
...
{$EXTERNALSYM PDEVICE_POWER_STATE}
  ...
  _SYSTEM_POWER_STATE = ( PowerSystemUnspecified, PowerSystemWorking,
...
{$EXTERNALSYM PSYSTEM_POWER_STATE}
  ...
  TCM_Power_Data = record
    ...
    PD_Capabilities, PD_D1Latency, PD_D2Latency, PD_D3Latency : ULONG;
    PD_PowerStateMapping : array [ 0 .. POWER_SYSTEM_MAXIMUM - 1 ]
      of DEVICE_POWER_STATE;
...
{$EXTERNALSYM CM_INSTALL_STATE_FINISH_INSTALL}
  CapabilitiesRelationships : array [ 0 .. 9 ] of TRelationship =
    ...
    ( Flag : CM_DEVCAP_SURPRISEREMOVALOK;
    Desc : 'CM_DEVCAP_SURPRISEREMOVALOK' ), ( Flag : CM_DEVCAP_HARDWAREDISABLED;
    Desc : 'CM_DEVCAP_HARDWAREDISABLED' ), ( Flag : CM_DEVCAP_NONDYNAMIC;
    Desc : 'CM_DEVCAP_NONDYNAMIC' ) );

  CONFIGFLAG_DISABLED = $00000001; // Set if disabled
{$EXTERNALSYM CONFIGFLAG_DISABLED}
  CONFIGFLAG_REMOVED = $00000002;
  // Set if a present hardware enum device deleted
{$EXTERNALSYM CONFIGFLAG_REMOVED}
  CONFIGFLAG_MANUAL_INSTALL = $00000004;
...
{$EXTERNALSYM CONFIGFLAG_VERIFY_HARDWARE}
  ConfigFlagRelationships : array [ 0 .. 15 ] of TRelationship =
    ...
    ( Flag : CONFIGFLAG_NEEDS_FORCED_CONFIG;
    Desc : 'CONFIGFLAG_NEEDS_FORCED_CONFIG' ), ( Flag : CONFIGFLAG_NETBOOT_CARD;
    Desc : 'CONFIGFLAG_NETBOOT_CARD' ), ( Flag : CONFIGFLAG_PARTIAL_LOG_CONF;
    Desc : 'CONFIGFLAG_PARTIAL_LOG_CONF' ),
    ( Flag : CONFIGFLAG_SUPPRESS_SURPRISE;
    Desc : 'CONFIGFLAG_SUPPRESS_SURPRISE' ),
    ( Flag : CONFIGFLAG_VERIFY_HARDWARE;
    Desc : 'CONFIGFLAG_VERIFY_HARDWARE' ) );
...
{$EXTERNALSYM PDCAP_WARM_EJECT_SUPPORTED}
  PDCAPRelationships : array [ 0 .. 8 ] of TRelationship =
    ...
    ( Flag : PDCAP_WAKE_FROM_D0_SUPPORTED;
    Desc : 'PDCAP_WAKE_FROM_D0_SUPPORTED' ),
    ( Flag : PDCAP_WAKE_FROM_D1_SUPPORTED;
    Desc : 'PDCAP_WAKE_FROM_D1_SUPPORTED' ),
    ( Flag : PDCAP_WAKE_FROM_D2_SUPPORTED;
    Desc : 'PDCAP_WAKE_FROM_D2_SUPPORTED' ),
    ( Flag : PDCAP_WAKE_FROM_D3_SUPPORTED;
    Desc : 'PDCAP_WAKE_FROM_D3_SUPPORTED' ),
    ( Flag : PDCAP_WARM_EJECT_SUPPORTED;
    Desc : 'PDCAP_WARM_EJECT_SUPPORTED' ) );
